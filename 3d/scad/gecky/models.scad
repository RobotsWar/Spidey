...
module gecky_model_tail_body(sizeSide=20, sizeLength=20, angleTail=45, lengthTail=40, widthTail=10, width=2.2) {
...
module gecky_model_leg(length=60, height=20, widthSizeBegin=20, widthSizeEnd=15, width=2.2, print=false) {
	size1 = 15;
	module part() {
		difference() {
	...
	if (print) {
		translate([-size1,0,height/2]) rotate(90, [1,0,0])
			gecky_model_leg(length=length, height=height, widthSizeBegin=widthSizeBegin, 
...
module gecky_model_foot(height=50, width=2.2, depth=4, widthSizeTop=15, widthSizeEnd=5, print=false) {
	if (print) {
		rotate(-90, [0,1,0])
			gecky_model_foot(height=height, width=width, depth=depth, 
...
module gecky_model_head_body(widthSize=5, width=2.2, print=false) {
	module part() {
		difference() {
...
module gecky_model_head_u(width=2.2, print=false) {
	if (print) {
